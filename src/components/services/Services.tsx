...
export function Services({ onOpenInquiry }: ServicesProps) {
  ...
  return (
    <section id="services" className="py-24 bg-bone relative border-b border-graphite/15">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {SERVICES.map((service) => (
            <div
              key={service.id}
              className="group bg-bone-card border border-graphite/20 hover:border-petrol p-8 transition-all duration-300 shadow-xs hover:shadow-xl flex flex-col justify-between relative overflow-hidden"
            >
              ...
              <div>
                <div className="flex items-center justify-between border-b border-graphite/15 pb-4 mb-6">
                  ...
                  <span className="font-mono text-[10px] font-semibold tracking-wider text-graphite-muted uppercase bg-bone px-2 py-1 border border-graphite/10">
                    {service.category}
                  </span>
                </div>
                ...
                <div className="my-6 bg-bone border border-graphite/10 p-4 rounded-xs flex items-center justify-center">
